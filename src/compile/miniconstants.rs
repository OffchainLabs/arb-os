...
pub struct ConstantsFile {
    integer: Vec<(String, u64)>,
    hex: Vec<(String, String)>,
    contract: Vec<String>,
}
...
pub fn init_constant_table(constants_path: Option<&Path>) -> HashMap<String, Uint256> {
    ...
    let consts = ConstantsFile {
        integer: (&[
            ...
            ("Estimate_L1GasPrice", 100 * 1_000_000_000),
        ])
            .into_iter()
        ...
        hex: (&[
            ...
            .collect(),
        contract: vec!["ArbRetryableTx".to_string(), "ArbStatistics".to_string()],
    };
