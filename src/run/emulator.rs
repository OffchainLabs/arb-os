            ...
            if let Some(insn) = self.code.get_insn(pc) {
                ...
                match insn.opcode {
                    ...
                    AVMOpcode::EcAdd => {
                        ...
                        let (z0, z1) = do_ecadd(x0, x1, y0, y1).map_err(|msg| ExecutionError::new(
                            &msg,
                            &self.state,
                            None,
                        ))?;
                    ...
                    AVMOpcode::EcMul => {
                        ...
                        let (z0, z1) = do_ecmul(x0, x1, n).map_err(|msg| ExecutionError::new(
                            &msg,
                            &self.state,
                            None,
                        ))?;
...
fn do_ecadd(x0: Uint256, x1: Uint256, y0: Uint256, y1: Uint256) -> Result<(Uint256, Uint256), &'static str> {
