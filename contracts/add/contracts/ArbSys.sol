...
interface ArbSys {
    ...
    event EthWithdrawal(address destAddr, uint amount);
    event Erc20Withdrawal(address destAddr, address tokenAddr, uint amount);
    event Erc721Withdrawal(address destAddr, address tokenAddr, uint id);
}
