...
(module
  ...
  (func (export "as-store-address") (result i32)
    (block (result i32)
      (i64.store (br_table 0 (i32.const 30) (i32.const 1)) (i64.const 7))
      (i32.const -1)
    )
  )
  ...
  (func (export "as-compare-left") (result i32)
    (block (result i32)
      (i64.le_s (br_table 0 0 (i32.const 43) (i32.const 0)) (i64.const 10))
    )
  )
  (func (export "as-compare-right") (result i32)
    (block (result i32)
      (i32.ne (i32.const 10) (br_table 0 (i32.const 42) (i32.const 0)))
    )
  )
