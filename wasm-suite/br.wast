...
(module
  ...
  (func (export "as-load-address") (result i32)
    (block (result i32) (i32.load (br 0 (i32.const 17))))
  )
  ...
  (func (export "as-store-address") (result i32)
    (block (result i32)
      (i64.store (br 0 (i32.const 30)) (i64.const 7)) (i32.const -1)
    )
  )
  ...
  (func (export "as-unary-operand") (result i32)
    (block (result i32) (i32.ctz (br 0 (i32.const 34))))
  )
  ...
  (func (export "as-compare-left") (result i32)
    (block (result i32) (i64.le_s (br 0 (i32.const 43)) (i64.const 10)))
  )
  (func (export "as-compare-right") (result i32)
    (block (result i32) (i32.ne (i32.const 10) (br 0 (i32.const 42))))
  )
...
(assert_return (invoke "as-load-address") (i32.const 17))
...
(assert_return (invoke "as-unary-operand") (i32.const 34))
