...
(module
  ...
  (func (export "test_dead_store") (result i32)
    (local $t i32)
    (i32.store (i32.const 8) (i32.const 0x23232323))
    (local.set $t (i32.load (i32.const 11)))
    (i32.store (i32.const 8) (i32.const 0))
    (local.get $t)
  )
...
(assert_return (invoke "zero_everything"))
(assert_return (invoke "test_redundant_load") (i32.const 0x00000080))
(assert_return (invoke "zero_everything"))
(assert_return (invoke "test_dead_store") (i32.const 0x23))
(assert_return (invoke "zero_everything"))
