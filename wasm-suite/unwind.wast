...
(module
  ...
  (func (export "unary-after-unreachable") (result i32)
    (i32.const 0) (unreachable) (i64.eqz)
  )
  (func (export "unary-after-br") (result i32)
    (block (result i32) (i32.const 0) (br 0 (i32.const 9)) (i64.eqz))
  )
  ...
  (func (export "unary-after-br_table") (result i32)
    (block (result i32)
      (i32.const 0) (br_table 0 0 (i32.const 9) (i32.const 0)) (i64.eqz)
    )
  )
  (func (export "unary-after-return") (result i32)
    (i32.const 0) (return (i32.const 9)) (i64.eqz)
  )

  (func (export "binary-after-unreachable") (result i32)
    (i32.const 0) (i64.const 1) (unreachable) (i64.eq)
  )
  (func (export "binary-after-br") (result i32)
    (block (result i32)
      (i32.const 0) (i64.const 1) (br 0 (i32.const 9)) (i64.eq)
    )
  )
  ...
  (func (export "binary-after-br_table") (result i32)
    (block (result i32)
      (i32.const 0) (i64.const 1) (br_table 0 (i32.const 9) (i32.const 0))
      (i64.eq)
    )
  )
  (func (export "binary-after-return") (result i32)
    (i32.const 0) (i64.const 1) (return (i32.const 9)) (i64.eq)
  )

  (func (export "select-after-unreachable") (result i32)
    (i32.const 0) (i64.const 1) (i64.const 0) (unreachable) (select)
  )
  (func (export "select-after-br") (result i32)
    (block (result i32)
      (i32.const 0) (i64.const 1) (i64.const 0) (br 0 (i32.const 9)) (select)
    )
  )
  ...
  (func (export "select-after-br_table") (result i32)
    (block (result i32)
      (i32.const 0) (i64.const 1) (i64.const 0)
      (br_table 0 (i32.const 9) (i32.const 0))
      (select)
    )
  )
  (func (export "select-after-return") (result i32)
    (i32.const 0) (i64.const 1) (i64.const 1) (return (i32.const 9)) (select)
  )

  (func (export "block-value-after-unreachable") (result i32)
    (block (result i32) (i32.const 0) (unreachable))
  )
  (func (export "block-value-after-br") (result i32)
    (block (result i32) (i32.const 0) (br 0 (i32.const 9)))
  )
  ...
  (func (export "block-value-after-br_table") (result i32)
    (block (result i32)
      (i32.const 0) (br_table 0 0 (i32.const 9) (i32.const 0))
    )
  )
  (func (export "block-value-after-return") (result i32)
    (block (result i32) (i32.const 0) (return (i32.const 9)))
  )

  (func (export "loop-value-after-unreachable") (result i32)
    (loop (result i32) (i32.const 0) (unreachable))
  )
  (func (export "loop-value-after-br") (result i32)
    (block (result i32) (loop (result i32) (i32.const 0) (br 1 (i32.const 9))))
  )
  ...
  (func (export "loop-value-after-br_table") (result i32)
    (block (result i32)
      (loop (result i32)
        (i32.const 0) (br_table 1 1 (i32.const 9) (i32.const 0))
      )
    )
  )
  (func (export "loop-value-after-return") (result i32)
    (loop (result i32) (i32.const 0) (return (i32.const 9)))
  )
)
